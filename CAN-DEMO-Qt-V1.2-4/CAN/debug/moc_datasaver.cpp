...
QT_MOC_LITERAL(3, 24, 13), // "errorOccurred"
QT_MOC_LITERAL(4, 38, 12) // "errorMessage"

    },
    "datasaver\0saveFinished\0\0errorOccurred\0"
    "errorMessage"
};
...
void datasaver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<datasaver *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (datasaver::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&datasaver::saveFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (datasaver::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&datasaver::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject datasaver::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_datasaver.data,
    qt_meta_data_datasaver,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void datasaver::saveFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void datasaver::errorOccurred(const QString & _t1)
{
