...
QT_MOC_LITERAL(4, 40, 3), // "vco"
QT_MOC_LITERAL(5, 44, 5), // "dwRel"
QT_MOC_LITERAL(6, 50, 7), // "channel"
QT_MOC_LITERAL(7, 58, 8), // "dataSent"
QT_MOC_LITERAL(8, 67, 9), // "boardInfo"
QT_MOC_LITERAL(9, 77, 14), // "VCI_BOARD_INFO"
QT_MOC_LITERAL(10, 92, 3), // "vbi"
QT_MOC_LITERAL(11, 96, 9), // "pcanError"
QT_MOC_LITERAL(12, 106, 6) // "status"

    },
    "CANThread\0getProtocolData\0\0VCI_CAN_OBJ*\0"
    "vco\0dwRel\0channel\0dataSent\0boardInfo\0"
    "VCI_BOARD_INFO\0vbi\0pcanError\0status"
};
...
void CANThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataSent((*reinterpret_cast< VCI_CAN_OBJ*(*)>(_a[1]))); break;
        case 2: _t->boardInfo((*reinterpret_cast< VCI_BOARD_INFO(*)>(_a[1]))); break;
        case 3: _t->pcanError((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CANThread::dataSent)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (CANThread::*)(unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CANThread::pcanError)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void CANThread::dataSent(VCI_CAN_OBJ * _t1)
{
...
// SIGNAL 3
void CANThread::pcanError(unsigned int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
